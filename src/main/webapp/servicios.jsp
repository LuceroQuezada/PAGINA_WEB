...
<html lang="es">
    <head>
        <meta charset="UTF-8">
        <title><fmt:message key="titulo.servicios" /></title>
    ...
    <body>
            ...
            <div class="container">
                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse" id="navMain">
                            <ul class="navbar-nav me-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link activo" href="servicios.jsp"><fmt:message key="titulo.servicios" /></a>
                                </li>
                ...
                <div class="header-content">
                    <div class="header-txt">
                        <span>Comprometidos con tu éxito académico</span>
                        <h1>PROFESORES ALTAMENTE CAPACITADOS</h1>
                        <p>
                            En Grupo A1, contamos con un equipo de <b>docentes altamente calificados</b>, con años de experiencia en la preparación para exámenes de ingreso a las universidades más prestigiosas. <b>Nuestro compromiso</b> es brindarte una formación de excelencia, acompañándote en cada paso para que alcances tus metas académicas con confianza y seguridad.
                        </p>
                    </div>
                    <div class="header-img">
                        <img src="img/PLANA.png" alt="Profesores">
                    </div>
                </div>
            </div>
        </header>
        ...
        <section class="centrame">
            ...
            <img src="img/banner1.png" alt="banner1" class="img" />
            <img src="img/banner2.png" alt="banner2" class="img" />
            <img src="img/banner3.png" alt="banner3" class="img" />
            <img src="img/banner4.png" alt="banner4" class="img" />
        </section>
