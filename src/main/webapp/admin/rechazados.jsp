...
<html lang="es">
    <head>
        <meta charset="UTF-8">
        <title>Preinscripciones Rechazadas</title>
        ...
        <div class="d-flex">
          <div class="sidebar">
            ...
            <div class="main-content">
                <h4 class="card-title text-center mb-4"><i class="fas fa-user-times"></i> Preinscripciones Rechazadas</h4>
                <div class="table-container">
                    <table class="table table-bordered align-middle">
                        ...
                        <tbody>
                            <c:forEach var="p" items="${listaRechazados}">
                                <tr class="${p.intentos >= 2 ? 'table-secondary' : ''}">
                                    <td>${p.dni}</td>
                                    <td>${p.nombres}</td>
                                    <td>${p.apellidos}</td>
                                    <td>${p.correo}</td>
                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${p.intentos >= 2}">
                                                <span class="badge bg-dark">Bloqueado</span>
                                                <!-- Botón para desbloquear -->
                                                <a href="desbloquearPreinscripcion?dni=${p.dni}"
