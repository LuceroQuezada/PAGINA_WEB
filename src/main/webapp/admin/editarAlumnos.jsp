...
<%@ page session="true" %>
<%@ page isELIgnored="false" %> <!-- ✅ Esto es lo que habilita EL -->
...
<body>
  <div class="d-flex">
    ...
    <div class="main-content">
        <div class="card p-4">
            <h3 class="card-title text-center mb-4"><i class="fas fa-edit"></i> Editar Alumno</h3>
            <form action="${pageContext.request.contextPath}/ActualizarAlumnoServlet" method="post" class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="password" class="form-control" value="${alumno.password}" required />
                </div>
                <div class="col-12 text-center">
                    <button type="submit" class="btn btn-success btn-form">Actualizar Alumno</button>
                    <a href="${pageContext.request.contextPath}/ListarAlumnosServlet" class="btn btn-secondary btn-form">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
