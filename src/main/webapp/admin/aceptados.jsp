...
<html lang="es">
    <head>
        <meta charset="UTF-8">
        <title>Preinscripciones Aceptadas</title>
    ...
    <body>
        <div class="d-flex">
            ...
            <div class="main-content">
                <h4 class="card-title text-center mb-4"><i class="fas fa-user-check"></i> Preinscripciones Aceptadas</h4>
                    ...
                    <table class="table table-bordered align-middle">
                        <thead class="table-dark">
                            <tr>
                                ...
                                <th>Carrera</th> <th>Acción</th>

                            </tr>
                        </thead>
                        <tbody>
                            <c:forEach var="p" items="${listaAceptados}">
                                <tr>
                                    <td>${p.dni}</td>
                                    <td>${p.nombres}</td>
                                    <td>${p.apellidos}</td>
                                    ...
                                    <td>${p.carrera}</td>
                                    <td>
                                        <a href="enviarCorreo?email=${p.correo}"
