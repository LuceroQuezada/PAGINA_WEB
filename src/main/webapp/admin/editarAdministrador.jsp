  ...
  <div class="d-flex">
    <div class="sidebar">
       ...
       <div class="main-content">
        <div class="card p-4">
            <h3 class="card-title text-center mb-4"><i class="fas fa-edit"></i> Editar Administrador</h3>
            <form action="${pageContext.request.contextPath}/ActualizarAdministradorServlet" method="post" class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="apellido" class="form-control" value="${admin.apellido}" required />
                </div>
                <div class="col-md-6">
                ...
                <div class="col-12 text-center">
                    ...
                    <a href="${pageContext.request.contextPath}/ListarAdministradoresServlet" class="btn btn-secondary btn-form">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
